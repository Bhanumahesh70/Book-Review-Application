...
router.post('/create', isAuthenticated,sanitizeInput, bookController.book_create_post);
...
router.post('/:id/update', isAuthenticated,sanitizeInput, bookController.book_update_post);
...
router.post('/:id/review', isAuthenticated, sanitizeInput,bookController.add_or_update_review_post);
...
router.post('/:id/review/update', isAuthenticated,sanitizeInput, bookController.update_review_post);
